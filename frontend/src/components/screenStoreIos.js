...
function ScreenStoreIos({ headerColor, storeIcon, text00, secondaryColor, logoTimeline, textColor }) {
                        ...
                        <div className="screen-three-store">
                            ...
                            <div className="app-info">
                                ...
                                <div className="app-details">
                                    ...
                                    <div>
                                        <button className="install-button-ios">ABRIR</button>
                                    </div>
                                </div>
                            </div>
